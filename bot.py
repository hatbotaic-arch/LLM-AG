...
async def handle_private_message(update, context):
    ...
    # Ограничиваем историю последними 10 сообщениями (плюс системное)
...
def main():
    ...
    if app.job_queue:
        ...
        logger.warning("JobQueue не установлен. Автопостинг не будет работать. Установите python-telegram-bot[job-queue]")
